...
//----------------------------------------------------------------------
//#define ANN_POW(v)		pow(fabs(v),ANN_NORM_p)
//#define ANN_ROOT(x)		pow(fabs(x),1/ANN_NORM_p)
//#define ANN_SUM(x,y)		((x) + (y))
//#define ANN_DIFF(x,y)	((y) - (x))

//----------------------------------------------------------------------
//	Use the following for L_4 norm
//----------------------------------------------------------------------
//inline ANNcoord ANN_POW(ANNcoord v) { ANNcoord v1 = v*v; return v1*v1; }
//#define ANN_ROOT(x) sqrt(sqrt(x))
//#define ANN_SUM(x,y)		((x) + (y))
//#define ANN_DIFF(x,y)	((y) - (x))
